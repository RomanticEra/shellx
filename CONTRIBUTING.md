# Contributing to RomanticEra

👍🎉 First off, thanks for taking the time to contribute! 🎉👍

These are mostly guidelines. Use your best judgment,
...
analysis_options.yaml sets global negation
analysis_options_xxx.yaml sets local **package** negation